...
<head>
  ...
  <title>Precious Adedokun - Resume</title>
...
<body class="bg-white text-gray-800 p-6 font-sans">
  <div class="max-w-4xl mx-auto space-y-10">
    ...
    <section class="border border-teal-200 rounded-lg p-6 shadow-sm">
      ...
      <div class="mb-6">
        <a href="https://proforms.top" target="_blank" class="text-lg font-semibold text-teal-700 hover:underline">
      ...
      <div class="mb-6">
        <a href="https://devbio.preciousadedokun.com.ng" target="_blank" class="text-lg font-semibold text-teal-700 hover:underline">
      ...
      <div>
        <a href="https://drake.zya.me" target="_blank" class="text-lg font-semibold text-teal-700 hover:underline">
        ...
        <div class="flex flex-wrap gap-2 mt-2 text-sm text-gray-600">
          ...
          <span class="badge">Livewire</span>
          <span class="badge">MySQL</span>
          <span class="badge">Payment Integration</span>
        </div>
      </div>
    </section>
    ...
    <section class="border border-teal-200 rounded-lg p-6 shadow-sm">
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-2 mt-1">
          <span class="badge text-gray-700 bg-gray-100">Open Source</span>
          <span class="badge text-gray-700 bg-gray-100">Tech Blogging</span>
          <span class="badge text-gray-700 bg-gray-100">Mentoring</span>
          <span class="badge text-gray-700 bg-gray-100">Photography</span>
        </div>
      </div>
    </section>
    ...
    <footer class="text-center text-sm text-gray-500 pt-6">
      References available upon request.  <?php echo date('Y') ?>
    </footer>
  </div>

  <style>
    .badge {
      @apply px-3 py-1 rounded-full text-sm border border-teal-200 bg-teal-50 text-teal-700;
    }
  </style>
</body>
</html>
